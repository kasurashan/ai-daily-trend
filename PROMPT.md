...
전체 메시지는 한국어 기준 약 1,800~2,800자를 목표로 한다.

정확한 판단에 필요한 경우 조금 초과할 수 있지만 3,500자를 넘기지 않는다.
...
- *핵심:* 실제로 무슨 일이 있었는지 1~2문장
- *달라진 점:* 기존 방식이나 이전 version과 비교해 무엇이 달라졌는지 1문장
- *왜 중요한가:* 실무적 의미, 적용 가능성 또는 핵심 한계 1문장
...
- *검증 상태:* 공개 code, reproduction, community reaction 또는 ablation 근거
- *왜 중요한가:* 실무적 의미 또는 한계
...
- 제목: 한 줄
- 핵심: 최대 2문장
- 달라진 점 또는 검증 상태: 최대 1문장
- 왜 중요한가: 1문장
- Takeaway: 1문장
- 주의: 필요한 경우 최대 1문장
- 출처: 원출처 1개, 필요한 경우 보조 출처 1개
